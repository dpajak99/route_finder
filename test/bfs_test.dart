...
void main() {
  ...
  test('', () async {
    BfsPathfinderAlgorithm bfs = BfsPathfinderAlgorithm(stopsGraph: stopsGraph, sourceVertex: vertex1, targetVertex: vertex7, startTime: DateTime(2023));
  ...
  test('', () async {
    BfsPathfinderAlgorithm bfs = BfsPathfinderAlgorithm(stopsGraph: stopsGraph, sourceVertex: vertex1, targetVertex: vertex9, startTime: DateTime(2023));

...
void main() {
  ...
  test('', () async {
    DfsPathfinderAlgorithm dfs = DfsPathfinderAlgorithm(graph: graph, sourceVertex: vertexA, targetVertex: vertexZ, startTime: DateTime(2023));

    PathfinderResult pathSearchResult = await dfs.searchPath(stopWhetTarget: false);

    print('-------------------');
    print('DFS Test raport');
    print('-------------------');

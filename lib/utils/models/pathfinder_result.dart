...
class StartAction extends PathFinderResultAction {
  ...
  @override
  String toString() {
    return 'START: ${minutesToTimeString(departureTime)} - ${sourceVertex.name} -> ${targetVertex.name} ';
  }
}
...
class EndAction extends PathFinderResultAction {
  ...
  @override
  String toString() {
    return 'END: ${minutesToTimeString(arrivalTime)} - ${sourceVertex.name} -> ${targetVertex.name} ';
  }
}
...
class TransferAction extends PathFinderResultAction {
  ...
  @override
  String toString() {
    return 'TRANSFER: ${minutesToTimeString(departureTime)} - ${sourceVertex.name} -> ${targetVertex.name} ';
  }
}
...
class WalkAction extends PathFinderResultAction {
  ...
  @override
  String toString() {
    return 'WALK: ${minutesToTimeString(departureTime)} - ${sourceVertex.name} -> ${targetVertex.name} ';
  }
}
...
class RideAction extends PathFinderResultAction {
  ...
  @override
  String toString() {
    return 'RIDE: ${minutesToTimeString(departureTime)} - ${sourceVertex.name} -> ${targetVertex.name} ';
  }
}
